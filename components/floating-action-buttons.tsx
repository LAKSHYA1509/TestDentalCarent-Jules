...
export function FloatingActionButtons() {
  const phoneNumber = '+919268245412';
  const whatsappNumber = '919268245412';

  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-40">
      <Button
        size="lg"
        className="rounded-full w-16 h-16 shadow-2xl bg-[#25D366] hover:bg-[#20BA5A] transition-all hover:scale-110 relative group p-0"
        onClick={() => window.open(`https://wa.me/${whatsappNumber}?text=Hi, I would like to know more about your dental services.`, '_blank')}
